...
if not DATABASE_URL:
    raise ValueError("DATABASE_URL environment variable is not set. Please create a .env file with DATABASE_URL=postgresql://postgres:postgres@localhost:5432/pharma_intel")
